...
kubeadm does not manage the underlying infrastructure (VMs, network) — it only configures the Kubernetes layer on top of an already-running OS.`,
      labSteps: [
        {
          ...
          clusterState: {
            ...
            events: ['Control plane initialized. CoreDNS Pending — CNI not yet installed.'],
        ...
        },
        {
          ...
          clusterState: {
            ...
            events: ['Flannel DaemonSet created', 'CoreDNS transitioned Pending → Running'],
          },
        },
        {
          id: 'p7-m1-s4',
      ...
      quiz: [
        ...
        },
        {
          ...
          options: ['admin.conf', 'controller-manager.conf', 'kubelet.conf', 'scheduler.conf'],
          answer: 1,
          explanation:
      ...
      exercises: [
        {
          ...
          expectedOutcome: 'All kubeadm init artifacts located and mapped to their init phases.',
          cleanup: [],
        },
        {
          id: 'p7-m1-e2',
          ...
          expectedOutcome: 'Bootstrap token regeneration procedure confirmed for CKA exam.',
          cleanup: [
      ...
      labSteps: [
        {
          ...
          command: 'export ETCDCTL_API=3 && kubectl get pods -n kube-system | grep etcd',
        ...
        },
        {
          ...
          instruction: 'Save a point-in-time snapshot of all cluster state to /tmp/etcd-backup.db.',
          command:
        ...
        },
        {
          ...
          command: 'etcdctl snapshot status /tmp/etcd-backup.db --write-out=table',
          output: [
            '+----------+----------+------------+------------+',
          ...
          clusterState: {
            ...
            deployments: [],
            namespaces: ['default', 'kube-system'],
            events: ['Snapshot status: 832 keys at revision 18423, 4.1 MB — valid'],
            highlightedComponent: 'etcd',
          },
        ...
        },
        {
          ...
          command: 'etcdctl snapshot restore /tmp/etcd-backup.db --data-dir=/var/lib/etcd-restore',
          output: [
      ...
      exercises: [
        {
          ...
          expectedOutcome: 'etcd backup procedure confirmed and all certificate flags memorized.',
...
| Uncordon after | N/A if not drained | Yes |`,
      labSteps: [
        {
          ...
          instruction: 'Verify the current version of all nodes before planning the upgrade.',
          command: 'kubectl get nodes',
          output: [
            'NAME     STATUS   ROLES           AGE   VERSION',
        ...
        },
        {
          ...
          output: ['# (systemctl commands produce no output on success)', 'node/node-2 uncordoned'],
          explanation:
      ...
      quiz: [
        ...
        {
          id: 'p7-m3-q2',
          question: 'What does "kubectl drain node-2 --ignore-daemonsets" do to the node?',
          options: [
      ...
      labSteps: [
        {
          ...
          clusterState: {
            ...
            deployments: [],
            namespaces: ['default', 'kube-system'],
            events: ['Certificate audit complete. All certs expire Jun 2027 (~364d remaining)'],
            highlightedComponent: 'apiserver',
          },
        ...
        },
        {
          ...
          clusterState: {
            ...
            deployments: [],
            namespaces: ['default', 'kube-system'],
            events: ['PKI directory listed. 3 root CAs identified: ca, etcd/ca, front-proxy-ca'],
            highlightedComponent: 'apiserver',
          },
        },
        {
        ...
        },
        {
          ...
          instruction: 'Renew only the apiserver certificate without affecting other certificates.',
        ...
        },
        {
          ...
          clusterState: {
            ...
            deployments: [],
            namespaces: ['default', 'kube-system'],
            events: ['kubeconfig raw view: cluster CA, client cert, client key all embedded'],
            highlightedComponent: 'apiserver',
          },
