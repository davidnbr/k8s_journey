...
function Box({ title, subtitle, accent = 'blue', className = '' }: NodeProps) {
  ...
  return (
    <div
      className={`border rounded-xl p-3 font-mono text-xs shadow-md transition-all hover:scale-[1.01] ${colors[accent]} ${className}`}
    >
...
function Arrow({
  ...
  direction?: 'down' | 'right' | 'up' | 'left' | 'double'
  text?: string
  className?: string
}) {
  ...
  return (
    <div
      className={`flex ${isHorizontal ? 'flex-row items-center' : 'flex-col items-center'} justify-center gap-1 font-mono text-[9px] text-slate-500 ${className}`}
    >
  ...
  return (
    <div className="flex flex-col gap-3 bg-slate-900/40 border border-slate-800 rounded-xl p-4 my-6">
      <div className="border border-purple-500/20 rounded-xl p-3 bg-purple-950/5">
        <div className="text-purple-300 text-[10px] font-bold uppercase mb-2">
          ⚙️ Control Plane (Brain)
        </div>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
          ...
          <Box
            title="kube-controller-mgr"
            subtitle="Desired state reconciliation"
            accent="yellow"
          />
        </div>
      </div>
      ...
      <div className="border border-green-500/20 rounded-xl p-3 bg-emerald-950/5">
        <div className="text-emerald-300 text-[10px] font-bold uppercase mb-2">
          📦 Worker Node (Muscle)
        </div>
...
function KubeconfigDiagram() {
  return (
    <div className="bg-slate-900/40 border border-slate-800 rounded-xl p-4 my-6">
      <div className="text-slate-400 text-[10px] font-bold uppercase mb-3">
      ...
      <div className="mt-2 grid grid-cols-1 md:grid-cols-2 gap-3">
        <Box
          title="Context: dev"
          subtitle="dev-cluster + dev-admin + namespace: default"
          accent="blue"
        />
        <Box
          title="Context: prod ★"
          subtitle="prod-cluster + prod-admin + namespace: production"
          accent="green"
        />
      </div>
    </div>
  ...
  return (
    <div className="bg-slate-900/40 border border-slate-800 rounded-xl p-4 my-6 flex flex-col items-center">
      <div className="border border-blue-500/30 rounded-xl p-4 w-full max-w-lg bg-blue-950/5">
        <div className="text-blue-300 font-mono text-[10px] font-bold uppercase mb-2">
          ☸️ Pod (IP: 10.244.1.5)
        </div>
        ...
        <Box
          ...
          subtitle="Memory-backed scratch folder mounted at /var/log"
          accent="green"
        />
      </div>
    </div>
  ...
  return (
    <div className="bg-slate-900/40 border border-slate-800 rounded-xl p-4 my-6 flex flex-col items-center gap-2">
      <Box
        ...
        subtitle="Desired: 3 replicas | Image: nginx:1.27 (v2)"
        accent="blue"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-xl">
        <div className="border border-emerald-500/20 rounded-xl p-3 bg-emerald-950/5">
          <div className="text-emerald-400 font-bold text-[10px] mb-2 text-center">
            Active ReplicaSet (v2-7f8d)
          </div>
        ...
        <div className="border border-slate-800 rounded-xl p-3 bg-slate-900/30 opacity-40">
          <div className="text-slate-500 font-bold text-[10px] mb-2 text-center">
            Old ReplicaSet (v1-56bc) [Scale: 0]
          </div>
          <div className="text-slate-600 text-center text-[10px] italic py-2">
            Maintained for rollbacks
          </div>
        </div>
      </div>
    </div>
...
function ServicesDiagram() {
  return (
    <div className="bg-slate-900/40 border border-slate-800 rounded-xl p-4 my-6 flex flex-col items-center gap-2">
      <Box
        title="🌐 External Client (curl http://web-service:80)"
        accent="slate"
        className="w-full max-w-sm text-center"
      />
      <Arrow />
      <Box
        title="🔌 Service (web-service) | ClusterIP: 10.96.45.100:80"
        subtitle="Stable IP matching labels app=web"
        accent="blue"
      ...
      <div className="grid grid-cols-2 gap-4 w-full max-w-md">
        <Box
          title="☸️ Pod (web-aaa)"
          subtitle="IP: 10.244.1.3 | Port 80"
          accent="green"
          className="text-center"
        />
        <Box
          title="☸️ Pod (web-bbb)"
          subtitle="IP: 10.244.2.4 | Port 80"
          accent="green"
          className="text-center"
        />
      </div>
...
function InitContainersDiagram() {
  return (
    <div className="bg-slate-900/40 border border-slate-800 rounded-xl p-4 my-6 flex flex-col items-center gap-2">
      <div className="text-slate-400 text-[10px] font-bold uppercase mb-1 self-start">
        Pod Startup Sequence
      </div>
      <Box
        title="1. init-container-1"
        subtitle="Runs to completion (exit 0) before anything else"
        accent="yellow"
        className="w-full max-w-md text-center"
      />
      <Arrow text="success" />
      <Box
        title="2. init-container-2"
        subtitle="Runs after init-1 completes (sequential)"
        accent="yellow"
        className="w-full max-w-md text-center"
      />
      <Arrow text="success" />
      <div className="grid grid-cols-2 gap-4 w-full max-w-md">
        <Box
          ...
          subtitle="Starts in parallel after all inits"
          accent="green"
          className="text-center"
        />
        <Box
          title="Main container B"
          subtitle="Starts in parallel after all inits"
          accent="green"
          className="text-center"
        />
  ...
  return (
    <div className="bg-slate-900/40 border border-slate-800 rounded-xl p-4 my-6">
      <div className="text-slate-400 text-[10px] font-bold uppercase mb-2">
        ☸️ Kubernetes Cluster (Physical Nodes)
      </div>
  ...
  return (
    <div className="bg-slate-900/40 border border-slate-800 rounded-xl p-4 my-6 flex flex-col items-center gap-2">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-lg">
        <Box
          title="🔌 Service (web)"
          subtitle="Selector: { app: web, tier: frontend }"
          accent="blue"
        />
      ...
      <div className="grid grid-cols-3 gap-2 w-full max-w-xl">
        <Box
          title="Pod 1"
          subtitle="Labels: { app: web, tier: frontend, env: prod }"
          accent="green"
        />
        <Box
          title="Pod 2"
          subtitle="Labels: { app: web, tier: frontend, env: dev }"
          accent="green"
        />
  ...
  return (
    <div className="bg-slate-900/40 border border-slate-800 rounded-xl p-4 my-6">
      <div className="flex flex-col items-center gap-2">
        <Box
          title="🗂️ ConfigMap (app-config)"
          subtitle="data: { DB_HOST: 'mysql-service', API_DEBUG: 'true' }"
          accent="yellow"
          className="w-full max-w-sm text-center"
        />
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-lg mt-2">
          <div className="flex flex-col items-center">
            ...
            <Box
              title="☸️ Pod Environment"
              subtitle="Injected at container start. Cannot sync live updates without container restarts."
              accent="blue"
              className="w-full"
            />
          </div>
          <div className="flex flex-col items-center">
            ...
            <Box
              title="📁 Volume Mount (/etc/config)"
              subtitle="Kubelet syncs symlink pointers dynamically. Updates live inside container."
              accent="green"
              className="w-full"
            />
          </div>
...
function SecretsDiagram() {
  return (
    <div className="bg-slate-900/40 border border-slate-800 rounded-xl p-4 my-6 flex flex-col items-center gap-2">
      <Box
        title="🔒 Secret (db-creds) | base64 encoded"
        subtitle="Stored securely in etcd with KMS Envelope encryption"
        accent="purple"
        className="w-full max-w-sm text-center"
      />
      ...
      <div className="border border-slate-800 rounded-xl p-3 w-full max-w-md bg-slate-900/30">
        ...
        <Box
          title="tmpfs Memory Volume"
          subtitle="Mounted to pod as virtual memory files. Never written to node local disk."
          accent="green"
        />
      </div>
    </div>
...
function ProbesDiagram() {
  return (
    <div className="bg-slate-900/40 border border-slate-800 rounded-xl p-4 my-6">
      <div className="text-slate-400 text-[10px] font-bold uppercase mb-3">
        ⏱️ Pod Startup & Health Lifecycle Timeline
      </div>
      <div className="flex flex-col md:flex-row items-stretch justify-between gap-2">
        <Box
          title="1. Container Starts"
          subtitle="Pulling image & init"
          accent="slate"
          className="flex-1 text-center"
        />
        <Arrow direction="right" className="hidden md:flex" />
        <Box
          title="2. Startup Probe"
          subtitle="Exposes initial check. Blocks other probes from killing app during slow initialization."
          accent="yellow"
          className="flex-1 text-center"
        />
        <Arrow direction="right" className="hidden md:flex" />
        <Box
          title="3. Liveness Probe"
          subtitle="Continuously checks app deadlock. Restarts container on fail."
          accent="red"
          className="flex-1 text-center"
        />
        <Arrow direction="right" className="hidden md:flex" />
        <Box
          title="4. Readiness Probe"
          subtitle="Checks app initialization. Connects/disconnects Service traffic."
          accent="green"
          className="flex-1 text-center"
        />
      </div>
    ...
    <div className="bg-slate-900/40 border border-slate-800 rounded-xl p-4 my-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="border border-blue-500/20 rounded-xl p-3 bg-blue-950/5">
          ...
          <Box
            title="Requests"
            subtitle="Assigned weight via cpu.shares. Used by scheduler for placement."
            accent="blue"
            className="mb-2"
          />
          <Box
            title="Limits"
            subtitle="Enforced via CFS CFS quotas. Container is throttled if exceeded; NEVER killed."
            accent="red"
          />
        </div>
        <div className="border border-purple-500/20 rounded-xl p-3 bg-purple-950/5">
          <div className="text-purple-300 font-bold text-[10px] mb-2">
            📉 Memory (Incompressible)
          </div>
          <Box
            title="Requests"
            subtitle="Used by scheduler. Ensures host memory capacity is reserved."
            accent="purple"
            className="mb-2"
          />
          <Box
            title="Limits"
            subtitle="Enforced via cgroups memory.max. Container is instantly OOMKilled if limits hit."
            accent="red"
          />
        </div>
      </div>
  ...
  return (
    <div className="bg-slate-900/40 border border-slate-800 rounded-xl p-4 my-6">
      <div className="flex flex-col md:flex-row items-stretch gap-2 justify-between">
        ...
        <Box
          title="💾 PVC (fast-pvc)"
          subtitle="Requests 5Gi of 'fast-storage'"
          accent="purple"
          className="flex-1"
        />
        <Arrow direction="right" className="hidden md:flex" />
        <Box
          title="⚙️ StorageClass"
          subtitle="Provisioner calls CSI CreateVolume"
          accent="blue"
          className="flex-1"
        />
        <Arrow direction="right" className="hidden md:flex" />
        <Box
          title="💿 PV (pv-block)"
          subtitle="Bound exclusively to PVC on cloud device"
          accent="green"
          className="flex-1"
        />
      </div>
  ...
  return (
    <div className="bg-slate-900/40 border border-slate-800 rounded-xl p-4 my-6 flex flex-col gap-3">
      <div className="text-[10px] font-bold text-slate-400 uppercase">
        StatefulSet Pod/Volume Sticky Mapping
      </div>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
        ...
        <Box
          ...
          subtitle="clusterIP: None (returns Pod IPs)"
          accent="purple"
        />
      </div>
  ...
  return (
    <div className="bg-slate-900/40 border border-slate-800 rounded-xl p-4 my-6">
      <div className="text-[10px] font-bold text-slate-400 uppercase mb-3">
        DaemonSet Controller (1 Pod Per Node)
      </div>
...
function IngressDiagram() {
  return (
    <div className="bg-slate-900/40 border border-slate-800 rounded-xl p-4 my-6 flex flex-col items-center gap-2">
      <Box
        title="🌐 Client HTTPS Request (https://myapp.com/api)"
        accent="slate"
        className="w-full max-w-sm text-center"
      />
      <Arrow />
      <Box
        title="🔌 Ingress Controller (L7)"
        subtitle="Terminates TLS. Inspects Host/Path headers. Bypasses Service proxy routing."
        accent="purple"
        className="w-full max-w-md text-center"
      />
...
function NetpolDiagram() {
  return (
    <div className="bg-slate-900/40 border border-slate-800 rounded-xl p-4 my-6">
      <div className="text-[10px] font-bold text-slate-400 uppercase mb-3">
        NetworkPolicy Stateful Traffic Isolation
      </div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-2 items-center">
        <Box title="Pod (role: frontend)" subtitle="Namespace: default" accent="green" />
        <div className="flex flex-col items-center">
          <Box
            title="🛡️ Policy: allow-ingress"
            subtitle="Selector app=db. Allows ingress only from role=frontend"
            accent="red"
          />
        ...
        <Box
          title="Pod (app: db)"
          subtitle="Blocked from all other namespace requests"
          accent="blue"
        />
      </div>
    </div>
...
function RbacDiagram() {
  return (
    <div className="bg-slate-900/40 border border-slate-800 rounded-xl p-4 my-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="border border-blue-500/20 rounded-xl p-3 bg-blue-950/5">
          <div className="text-blue-300 font-bold text-[10px] mb-2">
        ...
        <div className="border border-purple-500/20 rounded-xl p-3 bg-purple-950/5">
          <div className="text-purple-300 font-bold text-[10px] mb-2">
            ⚙️ ClusterRoleBinding (Cluster-wide)
          </div>
          <Box title="Subject: User / ServiceAccount" accent="slate" className="mb-2" />
          <Arrow />
          <Box
            title="ClusterRole"
            subtitle="verbs: [get, list, watch] | resources: [nodes, pv]"
            accent="purple"
          />
        </div>
      </div>
...
function JobsDiagram() {
  return (
    <div className="bg-slate-900/40 border border-slate-800 rounded-xl p-4 my-6 flex flex-col items-center gap-2">
      <Box
        title="⏰ CronJob (schedule: */5 * * * *)"
        subtitle="Triggers on cron timer schedule"
        accent="yellow"
        className="w-full max-w-sm text-center"
      />
      <Arrow />
      <Box
        title="🏃 Job (cleanup-run-1)"
        subtitle="Batch runner controller"
        accent="blue"
        className="w-full max-w-sm text-center"
      />
      <Arrow />
      <Box
        title="☸️ Pod (cleanup-run-1-xxxxx)"
        subtitle="Runs container script. Exits to status 'Completed' (exited 0)."
        accent="green"
        className="w-full max-w-sm text-center"
      />
    </div>
...
function HpaDiagram() {
  return (
    <div className="bg-slate-900/40 border border-slate-800 rounded-xl p-4 my-6 flex flex-col items-center gap-2">
      ...
      <Box
        title="⚙️ HPA Controller"
        subtitle="Computes: ceil(desired * current/target)"
        accent="blue"
        className="w-full max-w-sm text-center"
      />
      ...
      <Box
        title="🚀 Deployment"
        subtitle="Scales replicas count dynamically"
        accent="purple"
        className="w-full max-w-sm text-center"
      />
    </div>
    ...
    <div className="bg-slate-900/40 border border-slate-800 rounded-xl p-4 my-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="border border-slate-800 rounded-xl p-3 bg-slate-900/30">
          <div className="text-slate-400 font-bold text-[10px] mb-2">
            Taints & Tolerations (Repelling Nodes)
          </div>
          <Box
            title="Node: dedicated=gpu:NoSchedule"
            subtitle="Taint blocks normal pods"
            accent="red"
            className="mb-2"
          />
          <Box
            title="Pod (tolerations: dedicated=gpu)"
            subtitle="Allowed to schedule on tainted node"
            accent="green"
          />
        </div>
        <div className="border border-slate-800 rounded-xl p-3 bg-slate-900/30">
          <div className="text-slate-400 font-bold text-[10px] mb-2">
            Node/Pod Affinity (Attracting Pods)
          </div>
          <Box title="Node: disk=nvme" accent="slate" className="mb-2" />
          <Box
            title="Pod (nodeAffinity: disk=nvme)"
            subtitle="Scheduler must schedule Pod here"
            accent="blue"
          />
        </div>
      </div>
...
function PdbDiagram() {
  return (
    <div className="bg-slate-900/40 border border-slate-800 rounded-xl p-4 my-6 flex flex-col items-center gap-2">
      <Box
        title="⚠️ kubectl drain node-1"
        subtitle="Voluntary disruption trigger"
        accent="yellow"
        className="w-full max-w-sm text-center"
      />
      <Arrow />
      <Box
        title="🛡️ PodDisruptionBudget (PDB)"
        subtitle="minAvailable: 2 replicas | actual: 3 running"
        accent="red"
        className="w-full max-w-md text-center"
      />
      ...
      <div className="grid grid-cols-2 gap-4 w-full max-w-md">
        <Box
          title="Eviction: Pod A"
          subtitle="Evacuation allowed (2 left)"
          accent="green"
          className="text-center"
        />
        <Box
          title="Eviction: Pod B"
          subtitle="Blocked! (Would drop below minAvailable)"
          accent="red"
          className="text-center"
        />
      </div>
...
function HelmDiagram() {
  return (
    <div className="bg-slate-900/40 border border-slate-800 rounded-xl p-4 my-6">
      ...
      <div className="flex flex-col md:flex-row items-stretch gap-2 justify-between">
        <Box
          title="1. Chart Templates"
          subtitle="Go templates + defaults"
          accent="slate"
          className="flex-1"
        />
        <Arrow direction="right" className="hidden md:flex" />
        <Box
          title="2. Values Merge"
          subtitle="Overridden by user --set / -f"
          accent="blue"
          className="flex-1"
        />
        <Arrow direction="right" className="hidden md:flex" />
        <Box
          title="3. Rendered Manifest"
          subtitle="strategic merge patch"
          accent="purple"
          className="flex-1"
        />
        <Arrow direction="right" className="hidden md:flex" />
        <Box
          title="4. API Secret v1"
          subtitle="Saves release state in target namespace"
          accent="green"
          className="flex-1"
        />
      </div>
...
function KustomizeDiagram() {
  return (
    <div className="bg-slate-900/40 border border-slate-800 rounded-xl p-4 my-6">
      <div className="text-[10px] font-bold text-slate-400 uppercase mb-3">
        Kustomize Base / Overlay Inheritance
      </div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
...
function CrdsDiagram() {
  return (
    <div className="bg-slate-900/40 border border-slate-800 rounded-xl p-4 my-6 flex flex-col items-center gap-2">
      <Box
        title="⚙️ CustomResourceDefinition (CRD: Database)"
        subtitle="Registers /apis/example.com/v1/databases in API server"
        accent="purple"
        className="w-full max-w-sm text-center"
      />
      <Arrow />
      <div className="grid grid-cols-2 gap-4 w-full max-w-md">
        <Box
          title="1. Custom Resource (CR)"
          subtitle="spec: { engine: postgres, size: 50Gi }"
          accent="blue"
        />
        <Box
          title="2. Custom Controller"
          subtitle="SharedIndexInformer loops. Reconciles state."
          accent="green"
        />
      </div>
    </div>
    ...
    <div className="bg-slate-900/40 border border-slate-800 rounded-xl p-4 my-6">
      ...
      <div className="grid grid-cols-3 gap-2">
        ...
        <div className="flex flex-col gap-2">
          ...
          <Box
            title="FluentBit / Log tailer"
            subtitle="DaemonSet pipes to storage"
            accent="slate"
          />
        </div>
        <div className="flex flex-col gap-2">
...
function QosEvictionDiagram() {
  return (
    <div className="bg-slate-900/40 border border-slate-800 rounded-xl p-4 my-6">
      <div className="text-[10px] font-bold text-slate-400 uppercase mb-3">
        Memory Eviction & QoS Priority Hierarchy
      </div>
      <div className="flex flex-col gap-2">
        <div className="flex items-center justify-between border border-red-500/20 rounded-xl p-2 bg-red-950/5">
          ...
          <Box
            title="Evicted First"
            subtitle="No resource requests or limits configured"
            accent="red"
          />
        </div>
        ...
        <div className="flex items-center justify-between border border-emerald-500/20 rounded-xl p-2 bg-emerald-950/5">
          <span className="text-emerald-300 font-bold text-xs">
            Guaranteed (oom_score_adj: -997 to -998)
          </span>
...
function GitOpsDiagram() {
  return (
    <div className="bg-slate-900/40 border border-slate-800 rounded-xl p-4 my-6 flex flex-col items-center gap-2">
      <div className="text-slate-400 text-[10px] font-bold uppercase mb-1 self-start">
        GitOps Pull-Based Reconciliation Loop
      </div>
      <Box
        title="📁 Git Repository (desired state)"
        subtitle="manifests/ | helm/ | kustomize/"
        accent="blue"
        className="w-full max-w-sm text-center"
      />
      <Arrow text="ArgoCD polls every ~3 min or via webhook" />
      <Box
        title="⚙️ ArgoCD Application Controller"
        subtitle="Diffs live cluster state vs Git — detects drift"
        accent="purple"
        className="w-full max-w-md text-center"
      />
      <div className="grid grid-cols-2 gap-4 w-full max-w-md">
        <div className="flex flex-col items-center gap-1">
          <Box
            title="In Sync"
            subtitle="Git == Cluster. No action."
            accent="green"
        ...
        <div className="flex flex-col items-center gap-1">
          <Box
            title="OutOfSync"
            subtitle="Applies diff to Kubernetes API"
            accent="red"
            className="w-full text-center"
          />
        </div>
...
function ServiceMeshDiagram() {
  return (
    <div className="bg-slate-900/40 border border-slate-800 rounded-xl p-4 my-6">
      <div className="text-slate-400 text-[10px] font-bold uppercase mb-3">
        Istio Sidecar Pattern — mTLS & Traffic Control
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="border border-blue-500/20 rounded-xl p-3 bg-blue-950/5">
          ...
          <Box
            title="App Container"
            subtitle="Sends plain HTTP to localhost"
            accent="blue"
            className="mb-2"
          />
          <Box
            title="Envoy Sidecar (istio-proxy)"
            subtitle="Intercepts via iptables — upgrades to mTLS"
            accent="purple"
          />
        </div>
        <div className="border border-green-500/20 rounded-xl p-3 bg-emerald-950/5">
          ...
          <Box
            title="Envoy Sidecar (istio-proxy)"
            subtitle="Terminates mTLS — validates SPIFFE cert"
            accent="purple"
            className="mb-2"
          />
...
function CncfDiagram() {
  return (
    <div className="bg-slate-900/40 border border-slate-800 rounded-xl p-4 my-6">
      <div className="text-[10px] font-bold text-slate-400 uppercase mb-3">
        CNCF Project Maturity Lifecycle Funnel
      </div>
      <div className="flex flex-col gap-2">
        <div className="border border-slate-700 rounded-xl p-2 bg-slate-800/10 text-center">
          ...
          <div className="text-[10px] text-slate-500">
            Inception, early development, low production usage
          </div>
        </div>
        <div className="border border-yellow-500/20 rounded-xl p-2 bg-yellow-950/5 text-center">
          ...
          <div className="text-[10px] text-slate-400">
            Adopted by multiple teams, proven stability, audit check
          </div>
        </div>
        <div className="border border-emerald-500/20 rounded-xl p-2 bg-emerald-950/5 text-center">
          ...
          <div className="text-[10px] text-slate-300">
            Kubernetes, Helm, Prometheus, Envoy. Mature governance.
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-slate-900/40 border border-slate-800 rounded-xl p-4 my-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="border border-slate-800 rounded-xl p-3 bg-slate-900/30">
          <div className="text-slate-400 font-bold text-[10px] mb-2">
            Kubelet Node ready Lease Heartbeat
          </div>
          <Box
            title="Kubelet agent"
            subtitle="Exposes heartbeat checks"
            accent="green"
            className="mb-2"
          />
          <Arrow />
          <Box
            title="Node Lease object"
            subtitle="Checks Node health every 10s in kube-node-lease namespace"
            accent="blue"
          />
        </div>
        <div className="border border-slate-800 rounded-xl p-3 bg-slate-900/30">
          <div className="text-slate-400 font-bold text-[10px] mb-2">
            etcd Snapshot backup process
          </div>
          <Box
            title="Control Plane Node"
            subtitle="Runs etcdctl with server cert/keys"
            accent="purple"
            className="mb-2"
          />
          <Arrow />
          <Box
            title="Snapshot file (.db)"
            subtitle="Stored in local folder backup (e.g. /srv/data)"
            accent="green"
          />
        </div>
      </div>
  ...
  return (
    <div className="bg-slate-900/40 border border-slate-800 rounded-xl p-4 my-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="border border-slate-800 rounded-xl p-3 bg-slate-900/30">
          <div className="text-slate-400 font-bold text-[10px] mb-2">
            Infra (Pause) Container Namespace boundary
          </div>
          <Box
            title="Infra Container (Pause)"
            subtitle="Holds namespaces (Network, IPC) open"
            accent="purple"
            className="mb-2"
          />
        ...
        <div className="border border-slate-800 rounded-xl p-3 bg-slate-900/30">
          ...
          <Box
            title="1. initContainers"
            subtitle="Runs to completion sequentially"
            accent="yellow"
            className="mb-2"
          />
          <Arrow />
          <Box
            title="2. containers"
            subtitle="Runs in parallel after init succeeds"
            accent="green"
          />
        </div>
      </div>
